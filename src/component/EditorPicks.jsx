  ...
  return (
    <section className="py-16 w-11/12 mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <span className="text-gray-500">New products with updated stocks.</span>
        ...
        <div className="bg-white border rounded-l-lg p-4 shadow-sm relative flex flex-col justify-between">
          ...
          <div className="">
            ...
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="line-through text-gray-400 text-sm">$1.99</span>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <div className="flex  gap-2 mt-1">
                  <span className="text-red-500 font-bold text-lg">$2.45</span>
        ...
        <div className="bg-white border  p-4 shadow-sm relative flex flex-col justify-between">
          ...
          <div className="mt-3">
            ...
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="line-through text-gray-400 text-sm">$14.77</span>
            </div>
            <div className="text-xs text-gray-500 mb-1">
              This product is about to run out
            </div>
